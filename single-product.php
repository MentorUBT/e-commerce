...
<body>
    ...
    <main>
        <section class="product-summary e-padding">
            <div class="container">
                <div class="row">
                    <div class="wrapper">
                        <div class="product-preview">
                            <img src="assets/images/mockups/1920x1080/1.jpg" alt="">
                            <ul>
                                <li>
                                    <a href="#!">
                                        <img src="assets/images/mockups/640x427/1.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#!">
                        ...
                        <div class="product-overview">
                            <div class="product-title">
                                <h1>SONY WH-XB910N Wireless Headphones</h1>
                            </div>
                            <div class="product-details">
                                ...
                                <div class="product-description">
                                    ...
                                    <p>The quick, brown fox jumps over a lazy dog. DJs flock by when MTV ax quiz prog.
                                        ...
                                        zephyrs vex bold Jim. Quick zephyrs blow, vexing daft Jim.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="related-products products e-padding">
            <div class="container">
                <div class="title">
                ...
                <div class="row">
                    <article>
                        <img src="assets/images/mockups/640x427/1.jpg" alt="">
                        <a href="#!">Bluetooth Headphones Over Ear</a>
                        <p>$120.00</p>
                    </article>
                    <article>
                        <img src="assets/images/mockups/640x427/2.jpg" alt="">
                        <a href="#!">Apple Watch Series 7</a>
                        <p>$120.00</p>
                    </article>
                    <article>
                        <img src="assets/images/mockups/640x427/3.jpg" alt="">
                        <a href="#!">Sony WH-1000XM4 Wireless</a>
                        <p>$120.00</p>
                    </article>
                    <article>
                        <img src="assets/images/mockups/640x427/4.jpg" alt="">
